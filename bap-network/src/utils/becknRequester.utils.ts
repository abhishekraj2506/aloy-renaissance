...
export const makeBecknRequest = async (
  ...
  try {
    ...
    logger.info(`response from makeBecknRequest ${requestURL} ${JSON.stringify(response.data)}`)
    ...
    console.log(`Error in communicating with client protocol server ${error}`)
